...
set ::bali::simulation::Para(PROJECT) {sim_one_shot_counter_postmap}
set ::bali::simulation::Para(PROJECTPATH) {C:/lscc/diamond/2.0/examples/sync_controller}
set ::bali::simulation::Para(FILELIST) {"C:/lscc/diamond/2.0/examples/sync_controller/sync_controller_sync_controller_mapvho.vho" "C:/my_designs/sync_controller/sync_controller_rtl/src/TestBench/one_shot_counter_TB.vhd" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {TESTBENCH_FOR_one_shot_counter}

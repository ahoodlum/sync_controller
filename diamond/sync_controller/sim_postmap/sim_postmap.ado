...
set newDesign 0
if {![file exists "C:/lscc/diamond/2.0/examples/sync_controller/sim_postmap/sim_postmap.adf"]} { 
	design create sim_postmap "C:/lscc/diamond/2.0/examples/sync_controller"
  set newDesign 1
}
design open "C:/lscc/diamond/2.0/examples/sync_controller/sim_postmap"
...
addfile -sdf "C:/lscc/diamond/2.0/examples/sync_controller/sync_controller_sync_controller_mapvho.sdf"
	vlib "C:/lscc/diamond/2.0/examples/sync_controller/sim_postmap/work"
set worklib work
adel -all

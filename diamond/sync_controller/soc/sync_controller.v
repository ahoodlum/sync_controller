...
wire [7:0] slave_passthruS_DAT_O;
...
output [8-1:0] slave_passthruslv_master_data;
input [8-1:0] slave_passthruslv_slave_data;
...
slave_passthruS_en ? {4{slave_passthruS_DAT_O[7:0]}} : 
0;
...
.CFG_CALL_STACK_32(0),
.CFG_PROM_SIZE(2048),
.CFG_PROM_INIT_FILE("C:/Users/AndrewPC1/Documents/GitHub/sync_controller/software/uart_test/prom_init.mem"),
.CFG_PROM_INIT_FILE_FORMAT("hex"),
.SP_BASE_ADDRESS(32'h0),
.SP_SIZE(2048),
.SP_PORT_ENABLE(1),
.CFG_SP_INIT_FILE("C:/Users/AndrewPC1/Documents/GitHub/sync_controller/software/uart_test/scratchpad_init.mem"),
...
wire [7:0] slave_passthruS_DAT_I;
assign slave_passthruS_DAT_I = SHAREDBUS_DAT_I[7:0];
wire [0:0] slave_passthruS_SEL_I;
assign slave_passthruS_SEL_I = SHAREDBUS_SEL_I;
assign slave_passthruS_en = ( SHAREDBUS_ADR_I[31:4] == 28'b1000000000000000000000000010);
slave_passthru 
#(
.S_WB_DAT_WIDTH(8),
.S_WB_ADR_WIDTH(32))
...
.S_DAT_I(slave_passthruS_DAT_I[7:0]),
.S_DAT_O(slave_passthruS_DAT_O[7:0]),
.S_SEL_I(slave_passthruS_SEL_I),
...
assign LM8interrupts[1] = slave_passthruINTR_O ;
